...
# Summary: This program computes the molar mass of a substance and the number of moles of a sample of that substance. 
...
def main():
    ...
    chemical_formula = input("Chemical formula of the molecule: ")

    # Get the mass of a chemical sample in grams from the user.
    chemical_sample_mass = float(input("Mass of chemical sample: "))
    ...
    parsed_chemical_formula = parse_formula(chemical_formula, periodic_table)

    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    molar_mass = compute_molar_mass(parsed_chemical_formula, periodic_table)

    # Compute the number of moles in the sample.
    number_of_moles = chemical_sample_mass / molar_mass 
    ...
    formula_name = get_formula_name(chemical_formula, known_molecules)
