...
def main():
    try:
        ...
        print("You entered an invalid integer for the percentage reduction number.")
        print("Run the program again and enter an integer for" \
                " the percentage reduction number.")
        ...
        if perc_reduc < 0:
            ...
            print(f"{perc_reduc} is greater than 100")
        print("Run the program again and enter a percentage number" \
                " between 1 and 100.")
